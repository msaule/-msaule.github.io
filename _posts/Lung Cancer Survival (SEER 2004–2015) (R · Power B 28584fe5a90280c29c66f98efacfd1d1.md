...
Description: Full analysis of lung cancer, evaluating diagnosis stage, tumor size, gender, in R and Power BI.
...
- **R Code for Lung Cancer Survival Analysis**
    ...
    ```r
    # Convert survival months and create 2- & 5-year outcomes
    seer <- seer %>%
      mutate(
    ...
    ```r
    # Logistic regression for 2-year survival
    glm_fit <- glm(
